import {
  ...
  ThreadBoardColumnSetPayload as ContractsThreadBoardColumnSetPayloadSchema,
...
export const ThreadBoardColumnSetPayload = ContractsThreadBoardColumnSetPayloadSchema;
